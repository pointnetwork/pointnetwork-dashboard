...
console.log({xxx: process.env.WINDOWS_PFX_FILE, rx: process.env.WINDOWS_PFX_PASSWORD})
...
const msiCreator = new MSICreator({
    ...
    signWithParams: `sign /debug /a '/f' ${path.resolve(process.env.WINDOWS_PFX_FILE)} /p ${process.env.WINDOWS_PFX_PASSWORD}`,
