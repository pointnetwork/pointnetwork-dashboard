    ...
    <Dialog open={open}>
      <Box p={2}>
        ...
        <Typography mt={1} variant="body2" fontSize="8pt">
          <b>1.</b> Point Network is an uncensorable decentralized network. We just
          provide the software to you to access it, and it's up to you how to
          use it, however by using the software you agree to comply with our{' '}
          <Typography
            mt={1}
            variant="caption"
            color="primary"
          ...
          Be aware that users might upload all kinds of content
          (including NSFW), so if you're less than 18, ask your
          parents/guardians for their consent, meaning they should
          clearly understand what Point Network is before allowing you to use
          it.
        </Typography>
        <Typography mt={1} variant="body2" fontSize="8pt">
          <b>2.</b> Everything you upload and share on Point Network goes to
          permanent decentralized storage called Arweave, and stays there forever. Do not
        ...
        <Typography mt={1} variant="body2" fontSize="8pt">
          <b>4.</b> In alpha, we use installation and usage logs to support our alpha
